...
public class Writer extends JComponent {
    public void paint(Graphics g) {
        //рисование фона
        g.drawImage(new ImageIcon(Writer.class.getResource("C:/Users/User/Desktop/Литература/JAva/Race/src/Race/Images/BackGround.png")).getImage(), Main.xBackGround, 0, null);
